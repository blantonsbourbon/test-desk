...
public class ExecutionController {
    ...
    public ResponseEntity<ApiModels.ExecutionResponse> create(
        ...
        var execution = executionService.create(
                request.sourceId(),
                request.entryIds(),
                request.environment(),
    ...
    public ApiModels.ExecutionResponse get(@PathVariable("executionId") String executionId) {
        return mapper.toExecution(executionService.get(executionId));
    }

    @PostMapping("/{executionId}/cancel")
    public ApiModels.ExecutionResponse cancel(@PathVariable("executionId") String executionId) {
