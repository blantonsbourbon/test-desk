...
import com.acme.testcontrolplane.service.SourceService;
...
public class SourceController {
    ...
    @GetMapping("/{sourceId}")
    public ApiModels.SourceResponse get(@PathVariable String sourceId) {
        return mapper.toSource(sourceService.get(sourceId));
    }

    @PostMapping("/{sourceId}/sync")
    public ResponseEntity<ApiModels.SourceResponse> sync(@PathVariable String sourceId) {
